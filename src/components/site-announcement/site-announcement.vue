<template>
  <el-button class="site-announcement-btn border-box" :class="{
    dot: userSettings.showAnnouncement
  }" circle text @click="dialogVisible = true">
    <el-icon :size="22">
      <IEpBell />
    </el-icon>
  </el-button>
  <el-dialog v-model="dialogVisible" :title="$t('header.announcement.text_1')" width="500" :modal="false" draggable
    @close="onClose">
